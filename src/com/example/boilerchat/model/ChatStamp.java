	...
	*/
	public void save() throws Exception {
		...
		if (this.imageFile != null) {
			...
			KiiUploader uploader = this.kiiObject.uploader(BoilerChatApplication.getContext(), this.imageFile);
	...
	public Bitmap getImage() {
		...
		// Reads a image from local cache.
			...
			// Downloads a image from KiiCloud.
				...
				KiiDownloader downloader = this.kiiObject.downloader(BoilerChatApplication.getContext(), cacheFile);
