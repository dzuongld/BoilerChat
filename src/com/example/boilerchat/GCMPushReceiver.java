...
import com.kii.fb.android.R;
import com.example.boilerchat.ApplicationConst;
import com.example.boilerchat.BoilerChatApplication;
import com.example.boilerchat.model.ChatMessage;
import com.example.boilerchat.model.ChatRoom;
import com.example.boilerchat.ui.ChatActivity;
...
public class GCMPushReceiver extends BroadcastReceiver {
	...
	public GCMPushReceiver() {
		this.notificationManager = (NotificationManager)BoilerChatApplication.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
	}
	...
	private void showNotificationArea(ChatMessage chatMessage, KiiGroup kiiGroup) {
		if (this.notificationManager != null) {
			NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(BoilerChatApplication.getContext())
			.setSmallIcon(R.drawable.launcher)
			.setContentTitle("New message received")
			.setContentText(chatMessage.getMessage());
			Intent resultIntent = new Intent(BoilerChatApplication.getContext(), ChatActivity.class);
			resultIntent.putExtra(ChatActivity.INTENT_GROUP_URI, kiiGroup.toUri().toString());
			
			TaskStackBuilder stackBuilder = TaskStackBuilder.create(BoilerChatApplication.getContext());
